...
const ENV_URL = "https://meqvlr.herokuapp.com/api";
...
export class AuthService {
  ...
  createUser(email: string, role: boolean, password: string) {
  ...
  resetPassword(data: any) {
    this.httpClient.put(BACKEND_URL + "/reset", data).subscribe(
      () => {
  ...
  getUser(id: string) {
    ...
    return this.httpClient.get<{ userEmail: string, userRole:boolean }>(
      BACKEND_URL + "/email/" + id
    );
  }
  autoAuthUser() {
